...
def orm_to_route(row: RouteORM) -> Route:
    return Route(
        ...
        source_chat_canonical=getattr(row, "source_chat_canonical", None),
        target_adapter_id=row.target_adapter_id,
        target_platform=Platform(row.target_platform),
        target_chat_id=row.target_chat_id,
        target_chat_canonical=getattr(row, "target_chat_canonical", None),
        enabled=row.enabled,
